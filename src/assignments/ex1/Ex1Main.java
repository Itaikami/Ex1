            ...
            if (!num1.equals("quit")) {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        max[0]=num1;
                        max[1]=num2;
                        max[2]=Ex1.int2Number(Ex1.number2Int(num1)+Ex1.number2Int(num2),base);
                        max[3]=Ex1.int2Number(Ex1.number2Int(num1)*Ex1.number2Int(num2),base);
                        System.out.println("Max number over ["+max[0]+','+max[1]+','+max[2]+','+max[3]+"] is: "+max[Ex1.maxIndex(max)]);
                    }
                }
             }
        }
